...
var PopupLayer = new Class({
	...
	_loadOverlay:function(){                //加载遮罩
		...
		var wiseH=$(document).height();
		var wiseDiv="<div style='position:absolute;z-index:2;width:100%;height:100%;_height:"+wiseH+"px;left:0;top:0;opacity:0.3;filter:Alpha(opacity=30);background:#000'></div><iframe frameborder='0' border='0' style='width:100%;height:100%;position:absolute;z-index:1;left:0;top:0;filter:Alpha(opacity=0);'></iframe>";
		this.overlay.css({position:"absolute","z-index":100,left:0,top:0,zoom:1,display:"none",width:pageWidth,height:$(document).height()}).appendTo($(document.body)).append(wiseDiv)
	},
	doresize:function(){
